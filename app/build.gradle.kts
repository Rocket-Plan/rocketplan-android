...
android {
    ...
    productFlavors {
        ...
        create("staging") {
            ...
            buildConfigField("String", "CERT_PINS", "\"${localProperties.getProperty("cert.pins.staging", "")}\"")
            // Google Web Client ID for Credential Manager (from Google Cloud Console)
        ...
        create("prod") {
            ...
            buildConfigField("Boolean", "ALLOW_DESTRUCTIVE_MIGRATION", "false")
            buildConfigField("String", "CERT_PINS", "\"${localProperties.getProperty("cert.pins.prod", "")}\"")
            // Google Web Client ID for Credential Manager (from Google Cloud Console)
