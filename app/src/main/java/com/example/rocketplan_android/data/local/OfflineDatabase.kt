    ...
    companion object {
        ...
        private val MIGRATION_12_13 = object : Migration(12, 13) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // No-op: schema version bump only
            }
        }
        ...
        private val MIGRATION_24_25 = object : Migration(24, 25) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE offline_properties ADD COLUMN isMultiUnit INTEGER")
            }
        }

        private val MIGRATION_25_26 = object : Migration(25, 26) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE offline_moisture_logs ADD COLUMN dryingGoal REAL")
            }
        }
        ...
        private val MIGRATION_28_29 = object : Migration(28, 29) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE offline_materials ADD COLUMN projectId INTEGER")
            }
        }
        ...
        private val MIGRATION_29_30 = object : Migration(29, 30) {
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                database.execSQL(
                    "CREATE INDEX IF NOT EXISTS index_offline_locations_propertyServerId " +
                        "ON offline_locations(propertyServerId)"
                )
            }
        }
