...
class ClaimsInfoFragment : Fragment() {
    ...
    private fun onEditClaim(item: ClaimListItem) {
        ...
        policyHolderInput.setText(item.policyHolder.orEmpty())
        ownershipStatusInput.setText(item.ownershipStatus.orEmpty())
        phoneInput.setText(item.policyHolderPhone.orEmpty())
        emailInput.setText(item.policyHolderEmail.orEmpty())
        representativeInput.setText(item.representative.orEmpty())
        providerInput.setText(item.provider.orEmpty())
        deductibleInput.setText(item.insuranceDeductible.orEmpty())
        policyNumberInput.setText(item.policyNumber.orEmpty())
        claimNumberInput.setText(item.claimNumber.orEmpty())
        adjusterInput.setText(item.adjuster.orEmpty())
        adjusterPhoneInput.setText(item.adjusterPhone.orEmpty())
        adjusterEmailInput.setText(item.adjusterEmail.orEmpty())
