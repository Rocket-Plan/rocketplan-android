...
- **dev** - Development (`com.example.rocketplan_android.dev`)
- **staging** - Test/Staging (`com.example.rocketplan_android.staging`)
- **prod** - Production (`com.example.rocketplan_android`)
...
1. **HomeFragment/HomeViewModel** - Home screen
2. **GalleryFragment/GalleryViewModel** - Gallery screen
3. **SlideshowFragment/SlideshowViewModel** - Slideshow screen
