...
|----|----------|---------|-------|------|--------|-------|-------|-------|-----|---------|---------------|
| `RP-BUG-001` | P0 | — | Destructive Migration Enabled in Production | functional | pre_existing_latent | 1.0.00 | — | fixed | n/a | — | [RP-BUG-001](investigations/RP-BUG-001_destructive_migration.md) · [plan](plans/plan_critical_p0_001_006_2026-05-13.md) |
| `RP-BUG-002` | P0 | — | printStackTrace() Leaks Sensitive Data in Production | functional | new_code_bug | 1.0.00 | — | open | n/a | — | [RP-BUG-002](investigations/RP-BUG-002_printstacktrace_leak.md) |
| `RP-BUG-003` | P1 | — | PriorityQueue Thread-Safety Violation in SyncQueueManager | crash | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-003](investigations/RP-BUG-003_priorityqueue_threadsafety.md) |
| `RP-BUG-004` | P2 | — | Silent Fallback When ConnectivityManager Unavailable | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-004](investigations/RP-BUG-004_connectivity_silent_fallback.md) |
| `RP-BUG-005` | P0 | — | Non-Blocking Write to EncryptedSharedPreferences for Auth Token | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-005](investigations/RP-BUG-005_auth_token_apply.md) |
| `RP-BUG-006` | P0 | — | Race Condition in Auth Token Migration on Startup | functional | pre_existing_latent | 1.0.00 | — | fixed | n/a | — | [RP-BUG-006](investigations/RP-BUG-006_auth_token_race.md) · [plan](plans/plan_critical_p0_001_006_2026-05-13.md) |
| `RP-BUG-007` | P2 | — | Unshared OkHttpClient Configuration for Photo Cache | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-007](investigations/RP-BUG-007_photo_http_client.md) |
| `RP-BUG-008` | P0 | — | Sync Checkpoints Stored in Cleartext SharedPreferences | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-008](investigations/RP-BUG-008_sync_checkpoint_cleartext.md) |
| `RP-BUG-009` | P1 | — | Bitmap Memory Leak in Thumbnail Generation | memory | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-009](investigations/RP-BUG-009_bitmap_memory_leak.md) |
| `RP-BUG-010` | P1 | — | Unbounded Photo Sync Job Blocking Other Operations | hang | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-010](investigations/RP-BUG-010_sync_job_blocking.md) |
| `RP-BUG-011` | P2 | — | Certificate Pinning Not Implemented | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-011](investigations/RP-BUG-011_cert_pinning.md) |
| `RP-BUG-012` | P2 | — | Untracked Coroutine Scope in Application Startup | threading | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-012](investigations/RP-BUG-012_application_coroutine_scope.md) |
| `RP-BUG-013` | P1 | — | Swallowed Exception in ImageProcessorRetryWorker | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-013](investigations/RP-BUG-013_retry_worker_cancellation.md) |
| `RP-BUG-014` | P1 | — | Realm-like ID Pattern Fragile Migration Logic | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-014](investigations/RP-BUG-014_id_migration_fragile.md) |
| `RP-BUG-015` | P2 | — | Debounce May Not Prevent Rapid Re-enqueues | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-015](investigations/RP-BUG-015_debounce_rapid_enqueues.md) |
| `RP-BUG-016` | P1 | — | Missing Migration 27_28 in Database Version Sequence | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-016](investigations/RP-BUG-016_missing_migration.md) |
| `RP-BUG-017` | P2 | — | ImageProcessorQueueManager Shutdown Doesn't Wait for In-Flight Requests | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-017](investigations/RP-BUG-017_shutdown_inflight_requests.md) |
| `RP-BUG-018` | P2 | — | Session Object Printed in Debug Logging May Contain Sensitive Data | functional | new_code_bug | 1.0.00 | — | open | n/a | — | [RP-BUG-018](investigations/RP-BUG-018_session_logging.md) |
| `RP-BUG-019` | P2 | — | Potential ConcurrentModificationException in PhotoCacheManager | crash | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-019](investigations/RP-BUG-019_concurrent_modification.md) |
| `RP-BUG-020` | P2 | — | Error Handling Swallows Failures in ImageProcessorQueueManager | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-020](investigations/RP-BUG-020_queue_error_swallowed.md) |
| `RP-BUG-021` | P3 | — | Hardcoded Magic Numbers for Retry Configuration | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-021](investigations/RP-BUG-021_magic_numbers.md) |
| `RP-BUG-022` | P3 | — | Inefficient LRU Calculation in Photo Cleanup | performance | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-022](investigations/RP-BUG-022_lru_cleanup.md) |
| `RP-BUG-023` | P3 | — | TODO Comments for Incomplete Features in PeopleFragment | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-023](investigations/RP-BUG-023_todo_incomplete_features.md) |
| `RP-BUG-024` | P2 | — | Pusher throttledErrorTimestamps Unbounded Growth | functional | pre_existing_latent | 1.0.00 | — | fixed | unreleased | — | [RP-BUG-024](investigations/RP-BUG-024_pusher_throttle_map.md) · [plan](plans/plan_rp_bug_024_pusher_throttle_map_2026-05-18.md) |
| `RP-BUG-025` | P2 | — | LocalDataService.currentCompanyId Throws If Accessed Before Login | functional | pre_existing_latent | 1.0.00 | — | fixed | unreleased | — | [RP-BUG-025](investigations/RP-BUG-025_current_company_id_npe.md) · [plan](plans/plan_rp_bug_025_current_company_id_2026-05-18.md) |
| `RP-BUG-026` | P2 | — | SecureStorage.clearAll() Doesn't Clear migrationDeferred | functional | pre_existing_latent | 1.0.00 | — | fixed | unreleased | — | [RP-BUG-026](investigations/RP-BUG-026_clearall_migration_deferred.md) · [plan](plans/plan_rp_bug_026_clearall_migration_deferred_2026-05-18.md) |
| `RP-BUG-027` | P3 | — | Room SyncStatus Enum Comparisons Use String Parsing | functional | pre_existing_latent | 1.0.00 | — | fixed | unreleased | — | [RP-BUG-027](investigations/RP-BUG-027_syncstatus_string_parse.md) · [plan](plans/plan_rp_bug_027_syncstatus_storage_mapping_2026-05-18.md) |
| `RP-HD-001` | P2 | — | Audit every codebase touchpoint against every RP-CD rule | hardening | pre_existing_latent | 1.0.00 | — | investigating | n/a | — | [RP-HD-001](investigations/RP-HD-001_rp_cd_rule_audit.md) |
| `RP-HD-002` | P2 | — | Guard SecureStorage migration body against non-cancellation exceptions | hardening | new_code_bug | 1.0.00 | — | planned | n/a | — | [RP-HD-002](investigations/RP-HD-002_secure_storage_migration_exception_guard.md) · [plan](plans/plan_rp_hd_002_003_secure_storage_2026-05-18.md) · [review](reviews/code_review_RP-HD-002_003_2026-05-18.md) |
| `RP-HD-003` | P3 | — | Document ordering of legacy-token clear vs encrypted save in SecureStorage | hardening | new_code_bug | 1.0.00 | — | planned | n/a | — | [RP-HD-003](investigations/RP-HD-003_secure_storage_clear_save_ordering.md) · [plan](plans/plan_rp_hd_002_003_secure_storage_2026-05-18.md) · [review](reviews/code_review_RP-HD-002_003_2026-05-18.md) |
