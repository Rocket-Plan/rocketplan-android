...
| `RP-BUG-003` | P1 | — | PriorityQueue Thread-Safety Violation in SyncQueueManager | crash | pre_existing_latent | 1.0.00 | — | planned | n/a | — | [RP-BUG-003](investigations/RP-BUG-003_priorityqueue_threadsafety.md) · [plan](plans/plan_rp_bug_003_010_015_sync_queue_2026-06-01.md) |
...
| `RP-BUG-007` | P2 | — | Unshared OkHttpClient Configuration for Photo Cache | functional | pre_existing_latent | 1.0.00 | — | planned | n/a | — | [RP-BUG-007](investigations/RP-BUG-007_photo_http_client.md) · [plan](plans/plan_rp_bug_007_011_network_2026-06-01.md) |
| `RP-BUG-008` | P0 | — | Sync Checkpoints Stored in Cleartext SharedPreferences | functional | pre_existing_latent | 1.0.00 | — | planned | n/a | — | [RP-BUG-008](investigations/RP-BUG-008_sync_checkpoint_cleartext.md) · [plan](plans/plan_rp_bug_008_sync_checkpoint_cleartext_2026-06-01.md) |
...
| `RP-BUG-010` | P1 | — | Unbounded Photo Sync Job Blocking Other Operations | hang | pre_existing_latent | 1.0.00 | — | planned | n/a | — | [RP-BUG-010](investigations/RP-BUG-010_sync_job_blocking.md) · [plan](plans/plan_rp_bug_003_010_015_sync_queue_2026-06-01.md) |
| `RP-BUG-011` | P2 | — | Certificate Pinning Not Implemented | functional | pre_existing_latent | 1.0.00 | — | planned | n/a | — | [RP-BUG-011](investigations/RP-BUG-011_cert_pinning.md) · [plan](plans/plan_rp_bug_007_011_network_2026-06-01.md) |
...
| `RP-BUG-013` | P1 | — | Swallowed Exception in ImageProcessorRetryWorker | functional | pre_existing_latent | 1.0.00 | — | fixed | unreleased | — | [RP-BUG-013](investigations/RP-BUG-013_retry_worker_cancellation.md) · [plan](plans/plan_rp_bug_013_017_020_image_queue_2026-06-01.md) · [review](reviews/code_review_bug_bundle_2_2026-06-01.md) |
| `RP-BUG-014` | P1 | — | Realm-like ID Pattern Fragile Migration Logic | functional | pre_existing_latent | 1.0.00 | — | planned | n/a | — | [RP-BUG-014](investigations/RP-BUG-014_id_migration_fragile.md) · [plan](plans/plan_rp_bug_014_016_migration_2026-06-01.md) |
| `RP-BUG-015` | P2 | — | Debounce May Not Prevent Rapid Re-enqueues | functional | pre_existing_latent | 1.0.00 | — | planned | n/a | — | [RP-BUG-015](investigations/RP-BUG-015_debounce_rapid_enqueues.md) · [plan](plans/plan_rp_bug_003_010_015_sync_queue_2026-06-01.md) |
| `RP-BUG-016` | P1 | — | Missing Migration 27_28 in Database Version Sequence | functional | pre_existing_latent | 1.0.00 | — | planned | n/a | — | [RP-BUG-016](investigations/RP-BUG-016_missing_migration.md) · [plan](plans/plan_rp_bug_014_016_migration_2026-06-01.md) |
...
| `RP-BUG-023` | P3 | — | TODO Comments for Incomplete Features in PeopleFragment | functional | pre_existing_latent | 1.0.00 | — | open | n/a | — | [RP-BUG-023](investigations/RP-BUG-023_todo_incomplete_features.md) · [assessment](plans/plan_rp_bug_023_todo_incomplete_features_2026-06-01.md) |
