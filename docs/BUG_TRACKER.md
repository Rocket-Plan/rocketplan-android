...
| `RP-BUG-036` | P2 | — | Support conversations/messages duplicate on refresh — pull does no serverId reconciliation and client UUID is never sent, so a second row is inserted per server id | functional | pre_existing_latent | RP-CD-014 verification trace 2026-06-07 | — | open | unreleased | — | [RP-BUG-036](investigations/RP-BUG-036_support_duplicate_on_refresh.md) · rule [RP-CD-014](../architecture/RP-CD_rules.md) |
