...
| `RP-FR-005` | P3 | — | Support message attachments store server message id in local FK field, so future attachment reads will not reconcile (latent — attachment rendering not wired) | functional | pre_existing_latent | RP-BUG-036 identity trace 2026-06-07 | — | open | unreleased | — | [RP-FR-005](investigations/RP-FR-005_support_attachment_message_id_mismatch.md) · related [RP-BUG-036](investigations/RP-BUG-036_support_duplicate_on_refresh.md) |
