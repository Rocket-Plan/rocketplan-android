...
**Severity nuance:** production build 35 (released 2026-06-08) predates `389da21`, which introduced v31 — so **shipped users are not exposed**. The blast radius is the three test devices and any internal/alpha install built from master. This is a merge blocker for PR #8, not a production incident.
